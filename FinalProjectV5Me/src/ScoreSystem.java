...
{
	public static String FILE_LOC = "src\\scoreboard.txt";  //"src\\test.txt"; //File Location
	...
	public static void main(String[] args) throws IOException
	{
		...
		System.out.println("Would you like to reset the scoreboard? ('y' for yes) WARNING: THIS WILL ERASE ALL DATA");
	...
	public static void printScores(ArrayList<Score> scores) throws IOException
	{
		...
		for(int i = 0; i < 10; i++) //scores.size()
		{
